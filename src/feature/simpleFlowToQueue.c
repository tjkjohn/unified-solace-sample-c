...
/*
 * This sample shows how to create message Flows to Queues.
 * It demonstrates:
...
main ( int argc, char *argv[] )
{
    ...
    printf ( "\nsimpleFlowToQueue.c (Copyright 2007-2018 Solace Corporation. All rights reserved.)\n" );
    ...
    common_initCommandOptions(&commandOpts, 
                               ...
                               ( HOST_PARAM_MASK |
                                ...
                                USE_GSS_MASK |
                                ZIP_LEVEL_MASK |
                                REPLAY_START_MASK));                       /* optional parameters */
    ...
    if ( (char) 0 != commandOpts.replayStartLocation[0] ) {
        flowProps[propIndex++] = SOLCLIENT_FLOW_PROP_REPLAY_START_LOCATION;
        flowProps[propIndex++] = commandOpts.replayStartLocation;
    }
